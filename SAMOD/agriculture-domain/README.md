...
- **CropType**: A Type of Crop that can be Wheat or Corn
- **Crop**: A Crop of TypeCrop
- **Wheat**: A Wheat type of Crop
- **Corn**: A Corn type of Crop
- **LandSection**: A LandSection on a Farm that can grow crops of different CropTypes, and ist of square shape of length 1, characterised by their opposite corners at point coordinates
